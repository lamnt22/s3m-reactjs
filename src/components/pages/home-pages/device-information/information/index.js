...
import WarningLoad from "../../../home-pages/warning/load";
import WarningSolar from "../../../home-pages/warning/solar";
import WarningGrid from "../../../home-pages/warning/grid";
                            ...
                            }
                            {
                                ...
                                <>
                                    <div id="radios" onChange={(e) => {
                                        ...
                                        <span hidden={iDevice.deviceType == 3 || iDevice.deviceType == 5 || iDevice.deviceType == 6 || iDevice.deviceType == 9 ? true : false}>
                                        ...
                                        {iDevice.deviceType == 5 || iDevice.deviceType == 6 ?
                                            <>
                                                <span className="radio d-inline-block" style={{ backgroundColor: "#0a1a5c" }}>
                                                    <input className="with-gap" id="input10" name="radio" type="radio" value={12} defaultChecked />
                                                    <label htmlFor="input10">RATIO/EPPC</label>
                                                </span>
                                                <>
                                                    <span className="radio d-inline-block">
                                                        <input className="with-gap" id="input11" name="radio" type="radio" value={13} />
                                                        <label htmlFor="input11">INDICATOR</label>
                                                    </span>
                                                </>
                                            </> :
                                            <>
                                    ...
                                    <div className="form-group mt-2 mb-0 ml-2 calendar-equipment">
                                        ...
                                        <div className="input-group float-left" style={{ width: "270px" }}>
                                            ...
                                            {isActiveButton == 2 || isActiveButton == 3 ?
                                                <Calendar
                                                    id="from-value"
                                                    ...
                                                    <thead className={listDataInstance.length > 24 ? "headTable thead theadScroll" : "headTable thead"} >
                                                        {valueRadio == 8 || valueRadio == 9 ?
                                                            ...
                                                            <tr>
                                                                ...
                                                                {valueRadio == 5 &&
                                                                    <>
                                                                        {iDevice.systemTypeId == 2 && iDevice.deviceType == 1 ?
                                                                            <>
                                                                                <th style={{ width: "10%" }}>{t('content.home_page.manufacture.time')}</th>
                                                                                <th>
                                                                                    Epac
