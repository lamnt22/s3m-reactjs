        ...
        <>
                ...
                <table className={`table table-input`}>
                    <tbody>
                        ...
                        <tr className="vn">
                            ...
                            <td>
                                <input type="number" className="form-control input-number-m" name="vn" id="vn" defaultValue={formik.values.vn} />
                            </td>
                        </tr>
                        <tr className="in">
                            <th id="lb-imccb">{t('content.category.device.rated_current')} [A]</th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="in" id="in" />
                            </td>
                        </tr>
                        <tr className="cable_length">
                            <th>{t('content.category.device.cable_length')} [m]</th>
                            <td>
                                <input type="number" className="form-control" name="cable_length" id="cable_length" defaultValue={formik.values.cable_length} />
                            </td>
                        </tr>

                        <tr className="rho">
                            <th>{t('content.category.device.conductor_resisivity')} [Ohm/m]</th>
                            <td>
                                <input type="number" className="form-control" name="rho" id="rho" defaultValue={formik.values.rho} />
                            </td>
                        </tr>
                        <tr className="inc">
                            <th id="lb-imccb">{t('content.category.device.neutral_rated_current')} [A]</th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="inc" id="inc" />
                            </td>
                        </tr>
                        <tr className="uid">
                            <th width="180px">UID<span className="required">※</span></th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="uid" id="uid" />
...

            {
                ...
                bg-white rounded-md text-sm  ${props.isActive != 4 && "hidden"}`}>
                        <form onSubmit={formik.handleSubmit} id="form2">
                            <table className={`table table-input`}>
                                <tbody>
                                    <tr>
