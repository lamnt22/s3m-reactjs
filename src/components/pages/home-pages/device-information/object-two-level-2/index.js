                    ...
                    <div className="div-list-equipment">
                        ...
                        <div className="header-infor mt-1">
                            <div className="system-type">
                                ...
                                <div className="position-relative mt-1"><input id="inputName" type="text" className="" name="equipment-name" placeholder="   Tìm kiếm...." onChange={(e) => onFilterDeviceByName(e)} />
                                                    ...
                                                    <div className="body-equipment ml-5 d-flex">
                                                        ...
                                                        {device.statusDevice !== "offline" ?
                                                            <div className="float-left ml-2">
                                                                ...
                                                                <p className="text-color-ses-1 tagName" style={{ position: "absolute", top: "156px" }}>{device.uab >= 0 ? device.uab : "-"} V</p>
                                                                <p className="text-color-ses-1 tagName" style={{ position: "absolute", top: "183px" }}>{device.ia >= 0 ? device.ia : "-"} A</p>
                                                                <p className="text-color-ses-1 tagName" style={{ position: "absolute", top: "211px" }}>{device.pfa >= 0 ? device.pfa : "-"}</p>
                                                            </div>
                                                            :
                                                            <div className="float-left ml-2">
                                                                <p className="text-color-ses-1 tagName">{device.projectName}</p>
                                                    ...
                                                    <div className="body-equipment ml-5">
                                                        ...
                                                        {device.statusDevice !== "offline" ?
                                                            <div className="float-left ml-2">
                                                                ...
                                                                <p className="text-color-ses-1">{device.pfa >= 0 && device.pfa != null ? device.pfa : "-"}</p>
                                                            </div>
                                                            :
                                                            <div className="float-left ml-2">
                                                                <p className="text-color-ses-1">{device.projectName}</p>
