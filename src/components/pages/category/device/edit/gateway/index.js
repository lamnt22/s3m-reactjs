    ...
    return (
        <>
            ...
            <form onSubmit={formik.handleSubmit}>
                <table className={`table table-input `}>
                    <tbody>
                        ...
                        <tr className="vn">
                            ...
                            <td>
                                <input type="number" className="form-control input-number-m" name="vn" id="vn" onChange={formik.handleChange} defaultValue={formik.values.vn} />
                            </td>
                        </tr>
                        <tr className="sim_no">
                            <th>{t('content.category.device.sim')}<span className="required">※</span></th>
                            <td>
                                <input type="number" className="form-control" name="sim_no" id="sim_no" onChange={formik.handleChange} defaultValue={formik.values.sim_no} />
                            </td>
                        </tr>
                        <tr>
                ...
                <div id="main-button">
                    <button type="submit" className="btn btn-outline-secondary btn-agree mr-1 mb-3" data-dismiss="modal">
