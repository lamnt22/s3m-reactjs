                    ...
                    <div id={"select-device-content"} className="modal-content modal-select-content" >
                        <div className='box-select'>
                            <div className='modal-select-header'>
                                <button type="button" className={checkedType === 1 ? "btn btn-find-checked" : 'btn btn-find'} onClick={() => clickBtnFind(1)}>Tất cả điểm đo</button>
                                <button type="button" className={checkedType === 2 ? "btn btn-find-checked" : 'btn btn-find'} onClick={() => clickBtnFind(2)}>Điểm đo tổng</button>
                                <button hidden={props.new == undefined ? false : true} type="button" className={checkedType === 3 ? "btn btn-find-checked" : 'btn btn-find'} onClick={() => clickBtnFind(3)}>Khu vực</button>
                                <button hidden={props.new == undefined ? false : true} type="button" className={checkedType === 4 ? "btn btn-find-checked" : 'btn btn-find'} onClick={() => clickBtnFind(4)}>Loại thiết bị</button>
                                <button hidden={props.new != undefined ? false : true} type="button" className={checkedType === 7 ? "btn btn-find-checked" : 'btn btn-find'} onClick={() => clickBtnFind(7)}>Loại thiết bị</button>
                                <button type="button" className={checkedType === 5 ? "btn btn-find-checked" : 'btn btn-find'} onClick={() => clickBtnFind(5)} hidden={props.systemTypeId == 1 ? false : true}>Loại phụ tải</button>
                                <button type="button" className={checkedType === 6 ? "btn btn-find-checked" : 'btn btn-find'} onClick={() => clickBtnFind(6)}>Sơ đồ</button>
                            </div>
                            ...
                            <div className='modal-select-footer'>
                                <button type="button" className="btn btn-confirm" style={{ marginRight: '1.5%' }} data-dismiss="modal" onClick={() => sendData(selectedDevices)}>Đồng ý</button>
