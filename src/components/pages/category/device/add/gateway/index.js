...
const Gateway = (props) => {
    ...
    const addDevice = () => {
        $.confirm({
            ...
            content: t('content.category.device.list.add_sucess'),
            buttons: {
                confirm: {
    ...
    const keepValueForm = () => {
        ...
        formik.setFieldValue("sim_no", $('#sim_no').val());
        ...
        <>
            ...
            <div id="formValue" className={`relative flex flex-col items-center justify-center mt-5 p-2 
                ...
                <table className={`table table-input `}>
                    <tbody>
                        ...
                        <tr className="vn">
                            <th id="lb-imccb">{t('content.category.device.rated_voltage')} [Vdc]</th>
                            <td>
                        ...
                        <tr className="sim_no">
                            <th>{t('content.category.device.sim')}<span className="required">※</span></th>
                            <td>
                                <input type="number" className="form-control" name="sim_no" id="sim_no" onChange={formik.handleChange} />
                            </td>
                        </tr>
                        <tr>
...

            {
                ...
                bg-white rounded-md text-sm  ${props.isActive != 4 && "hidden"}`}>
                        <form onSubmit={formik.handleSubmit} id="form6">
                            <table className={`table table-input `}>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr className="vn">
                                        <th id="lb-imccb">{t('content.category.device.rated_voltage')} [Vdc]</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="vn" id="vn" onChange={formik.handleChange} defaultValue={formik.values.vn} disabled />
                                        </td>
                                    </tr>
                                    <tr className="sim_no">
                                        <th>{t('content.category.device.sim')}<span className="required">※</span></th>
                                        <td>
                                            <input type="number" className="form-control" name="sim_no" id="sim_no" onChange={formik.handleChange} defaultValue={formik.values.sim_no} disabled />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>{t('content.description')}</th>
