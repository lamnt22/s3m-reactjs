...
const MeterInverter = (props) => {
    ...
    const keepValueForm = () => {
        ...
        formik.setFieldValue("pdc_max", $('#pdc_max').val());
        formik.setFieldValue("vdc_max", $('#vdc_max').val());
        formik.setFieldValue("vdc_rate", $('#vdc_rate').val());
        formik.setFieldValue("vac_rate", $('#vac_rate').val());
        formik.setFieldValue("idc_max", $('#idc_max').val());
        formik.setFieldValue("iac_rate", $('#iac_rate').val());
        formik.setFieldValue("iac_max", $('#iac_max').val());
        formik.setFieldValue("pac", $('#pac').val());
                ...
                <table className={`table table-input `}>
                    <tbody>
                        ...
                        <tr className="pdc_max">
                            ...
                            <td>
                                <input type="number" className="form-control input-number-m" name="pdc_max" id="pdc_max" defaultValue={formik.values.pdc_max} onChange={formik.handleChange} />
                            </td>
                        </tr>
                        <tr className="vdc_max">
                            <th id="lb-imccb">{t('content.category.device.dc_input_voltage_max')}</th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="vdc_max" id="vdc_max" defaultValue={formik.values.vdc_max} onChange={formik.handleChange} />
                            </td>
                        </tr>
                        <tr className="vdc_rate">
                            <th id="lb-imccb">{t('content.category.device.rated_dc_input_voltage')}</th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="vdc_rate" id="vdc_rate" defaultValue={formik.values.vdc_rate} onChange={formik.handleChange} />
                            </td>
                        </tr>
                        <tr className="idc_max">
                            <th id="lb-imccb">{t('content.category.device.input_current_dc_max')}</th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="idc_max" id="idc_max" defaultValue={formik.values.idc_max} onChange={formik.handleChange} />
                            </td>
                        </tr>
                        ...
                        <tr className="pac">
                            ...
                            <td>
                                <input type="number" className="form-control input-number-m" name="pac" id="pac" defaultValue={formik.values.pac} onChange={formik.handleChange} />
                            </td>
                        </tr>
                        <tr className="iac_rate">
                            <th id="lb-imccb">{t('content.category.device.rated_ac_output_current')}</th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="iac_rate" id="iac_rate" defaultValue={formik.values.iac_rate} onChange={formik.handleChange} />
                            </td>
                        </tr>
                        <tr className="iac_max">
                            <th id="lb-imccb">{t('content.category.device.max_ac_output_current')}</th>
                            <td>
                                <input type="number" className="form-control input-number-m" name="iac_max" id="iac_max" defaultValue={formik.values.iac_rate} onChange={formik.handleChange} />
                            </td>
                        </tr>
                        ...
                        <tr className="vac_rate">
                            ...
                            <td>
                                <input type="number" className="form-control input-number-m" name="vac_rate" id="vac_rate" defaultValue={formik.values.vac_rate} onChange={formik.handleChange} />
                            </td>
                        </tr>
                            ...
                            <table className={`table table-input `}>
                                <tbody>
                                    ...
                                    <tr className="pdc_max">
                                        <th>{t('content.category.device.dc_capacity_max')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="pdc_max" id="dc-power" value={formik.values.pdc_max} disabled />
                                        </td>
                                    </tr>
                                    <tr className="vdc_max">
                                        <th id="lb-imccb">{t('content.category.device.dc_input_voltage_max')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="vdc_max" id="vdc_max" value={formik.values.vdc_max} disabled />
                                        </td>
                                    </tr>
                                    <tr className="vdc_rate">
                                        <th id="lb-imccb">{t('content.category.device.rated_dc_input_voltage')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="vdc_rate" id="vdc_rate" value={formik.values.vdc_rate} disabled />
                                        </td>
                                    </tr>
                                    <tr className="idc_max">
                                        <th id="lb-imccb">{t('content.category.device.input_current_dc_max')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="idc_max" id="idc_max" value={formik.values.idc_max} disabled />
                                        </td>
                                    </tr>
                                    ...
                                    <tr className="pac">
                                        <th>{t('content.category.device.rated_ac_output_power')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="pac" id="ac-power" value={formik.values.pac} disabled />
                                        </td>
                                    </tr>
                                    <tr className="iac_rate">
                                        <th id="lb-imccb">{t('content.category.device.rated_ac_output_current')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="iac_rate" id="iac_rate" value={formik.values.iac_rate} disabled />
                                        </td>
                                    </tr>
                                    <tr className="iac_max">
                                        <th id="lb-imccb">{t('content.category.device.max_ac_output_current')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="iac_max" id="iac_max" value={formik.values.iac_max} disabled />
                                        </td>
                                    </tr>
                                    ...
                                    <tr className="vac_rate">
                                        <th id="lb-imccb">{t('content.category.device.rated_ac_voltage')}</th>
                                        <td>
                                            <input type="number" className="form-control input-number-m" name="vac_rate" id="vac_rate" value={formik.values.vac_rate} disabled />
                                        </td>
                                    </tr>
                                    <tr className="eff string">
                                        <th>{t('content.category.device.efficiency')} [%]</th>
                                        <td>
                                            <input type="number" className="form-control" name="eff" id="eff" value={formik.values.eff} disabled />
                                        </td>
                                    </tr>
                                    <tr className="uid">
                                        <th width="180px">UID<span className="required">※</span></th>
