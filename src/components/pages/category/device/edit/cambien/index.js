        ...
        <>
            {
                ...
                <div className="alert alert-danger" role="alert">
                    <p className="m-0 p-0">{t('content.category.device.edit.error_edit')}</p>
                </div>
            }
            {
                ...
                <table className={`table table-input `}>
                    <tbody>
                        ...
                        <tr className="battery_capacity">
                            ...
                            <td>
                                <input type="number" className="form-control" name="battery_capacity" id="battery_capacity" onChange={formik.handleChange} defaultValue={formik.values.battery_capacity} />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select className="custom-select  fuelTypeId" id="fuelTypeId" name="fuelTypeId" onChange={formik.handleChange} defaultValue={formik.values.fuelTypeId}>
                                    <option value=""></option>
