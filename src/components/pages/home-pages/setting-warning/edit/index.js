    ...
    const formik = useFormik({
        ...
        onSubmit: async (data) => {
            ...
            if (response.status === 200) {
                setLoading(false);
                history.push({
                    pathname: `/${customerId}/setting-warning`,
                    state: {
                        status: 200,
    ...
    return (<>
        <div id="page-body">
            <div className="title-up-warning text-left">
                <div style={{ marginTop: "-21px", color: "white" }}><i className="fa-solid fa-gear ml-1" style={{ color: "#fff" }}></i> {t('content.home_page.warning_setting.edit_setting')}
                </div>
            </div>

            <form onSubmit={formik.handleSubmit}>
                <div id="main-content">
                    {loading === true ? <div style={{ position: 'absolute', top: '30%', left: "47%" }}>
                    ...
                    <table className="table table-input">
                        <tbody>
                            <tr>
                                <th width="150px">{t('content.home_page.warning_setting.name_setting')}</th>
                                <td>
                            ...
                            <tr>
                                <th width="150px">{t('content.home_page.warning_setting.value')}</th>
                                {
                                ...
                                }
                                {
                                    ...
                                    <td>
                                        <span className="form-control" style={{ backgroundColor: "#EBEBEB" }}> Giá điện giờ thấp điểm {"="}  <input type="number" step="1" id="setting-value" name="settingValue" onChange={formik.handleChange} defaultValue={formik.values.settingValue} className="form-control d-inline-block" style={{ width: "60px" }} /> VNĐ </span>
                                    </td>
                                }
                                {
                                    settings?.settingMstId === 50 &&
                                    <td>
                                        <span className="form-control" style={{ backgroundColor: "#EBEBEB" }}> Giá điện giờ bình thường {"="}  <input type="number" step="1" id="setting-value" name="settingValue" onChange={formik.handleChange} defaultValue={formik.values.settingValue} className="form-control d-inline-block" style={{ width: "60px" }} /> VNĐ </span>
                                    </td>
                                }
                                {
                                    settings?.settingMstId === 51 &&
                                    <td>
                                        <span className="form-control" style={{ backgroundColor: "#EBEBEB" }}> Giá điện giờ cao điểm {"="}  <input type="number" step="1" id="setting-value" name="settingValue" onChange={formik.handleChange} defaultValue={formik.values.settingValue} className="form-control d-inline-block" style={{ width: "60px" }} /> VNĐ </span>
                                    </td>
                                }
                                {
                                    settings?.settingMstId === 52 &&
                                    <td>
                                        <span className="form-control" style={{ backgroundColor: "#EBEBEB" }}> Tiền bán điện giờ tháp điểm {"="}  <input type="number" step="1" id="setting-value" name="settingValue" onChange={formik.handleChange} defaultValue={formik.values.settingValue} className="form-control d-inline-block" style={{ width: "60px" }} /> VNĐ </span>
                                    </td>
                                }
                                {
                                    settings?.settingMstId === 53 &&
                                    <td>
                                        <span className="form-control" style={{ backgroundColor: "#EBEBEB" }}> Tiền bán điện giờ bình thường {"="}  <input type="number" step="1" id="setting-value" name="settingValue" onChange={formik.handleChange} defaultValue={formik.values.settingValue} className="form-control d-inline-block" style={{ width: "60px" }} /> VNĐ </span>
                                    </td>
                                }
                                {
                                    settings?.settingMstId === 54 &&
                                    <td>
                                        <span className="form-control" style={{ backgroundColor: "#EBEBEB" }}> Tiền bán điện giờ cao điểm {"="}  <input type="number" step="1" id="setting-value" name="settingValue" onChange={formik.handleChange} defaultValue={formik.values.settingValue} className="form-control d-inline-block" style={{ width: "60px" }} /> VNĐ </span>
                                    </td>
                                }
                            </tr>
                            <tr>
                                <th width="150px">{t('content.home_page.warning_setting.warning_level')}</th>
                                {
                                    (settings?.settingMstId) &&
                                    <td>
                                        <span className="form-control" style={{ backgroundColor: "#EBEBEB" }}>
                                            <div className="form-check form-check-inline mr-2">
                                                <input className="form-check-input" type="radio" name="warningLevel" id="inlineRadio1" value={3} style={{ transform: "scale(1.5)" }} defaultChecked={settings.warningLevel === 3 ? true : false} onChange={formik.handleChange} />
                                                <label className="form-check-label" htmlFor="inlineRadio1">{t('content.home_page.warning_setting.high')}</label>
                                            </div>
                                            <div className="form-check form-check-inline mr-2">
                                                <input className="form-check-input" type="radio" name="warningLevel" id="inlineRadio2" value={2} style={{ transform: "scale(1.5)" }} defaultChecked={settings.warningLevel === 2 ? true : false} onChange={formik.handleChange} />
                                                <label className="form-check-label" htmlFor="inlineRadio2">{t('content.home_page.warning_setting.medium')}</label>
                                            </div>
                                            <div className="form-check form-check-inline mr-2">
                                                <input className="form-check-input" type="radio" name="warningLevel" id="inlineRadio3" value={1} style={{ transform: "scale(1.5)" }} defaultChecked={settings.warningLevel === 1 ? true : false} onChange={formik.handleChange} />
                                                <label className="form-check-label" htmlFor="inlineRadio3">{t('content.home_page.warning_setting.low')}</label>
                                            </div>
                                        </span>
                                    </td>
                                }
