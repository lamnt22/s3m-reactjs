                ...
                <table className="table">
                    <thead>
                        <tr>
                            ...
                            <th width="170px">{t('content.system')}</th>
                                ...
                                (project, index) => <tr key={project.projectId}>
                                    ...
                                    <td className="text-center" style={{ wordWrap: "break-word" }}>
                                        <Link to={`/category/tool-page/egrid-page/${customerId}/${project.projectId}/2`}>
                                            <img src={project.solarNum > 0 ? '/resources/image/system/icon-solar-energy-active.png' : '/resources/image/system/icon-solar-energy-inactive.png'}
                                                style={{ height: 24, marginRight: 3 }}></img>
                                        </Link>
                                        <Link to={`/category/tool-page/egrid-page/${customerId}/${project.projectId}/3`}>
                                            <img src={project.windNum > 0 ? '/resources/image/system/icon-wind-energy-active.png' : '/resources/image/system/icon-wind-energy-inactive.png'}
                                                style={{ height: 24, marginRight: 3 }}></img>
                                        </Link>
                                        <Link to={`/category/tool-page/egrid-page/${customerId}/${project.projectId}/4`}>
                                            <img src={project.evNum > 0 ? '/resources/image/system/icon-ev-energy-active.png' : '/resources/image/system/icon-ev-energy-inactive.png'}
                                                style={{ height: 24, marginRight: 3 }}></img>
                                        </Link>
                                        <Link to={`/category/tool-page/egrid-page/${customerId}/${project.projectId}/5`}>
                                            <img src={project.utilityNum > 0 ? '/resources/image/system/icon-utility-energy-active.png' : '/resources/image/system/icon-utility-energy-inactive.png'}
                                                style={{ height: 24, marginRight: 3 }}></img>
                                        </Link>
                                        <Link to={`/category/tool-page/egrid-page/${customerId}/${project.projectId}/1`}>
                                            <img src={project.loadNum > 0 ? '/resources/image/system/icon-load-energy-active-full.png' : '/resources/image/system/icon-load-energy-inactive-full.png'}
                                                style={{ height: 24 }}></img>
                                        </Link>
                                    </td>
